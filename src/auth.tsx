  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        if (!organization_name || !scope || !client_id || !redirect_uri) {
        ...
        try {
          ...
          const tokenData = await fetchOAuth2Token(organization_name, client_id, authCode, redirect_uri);
      ...
      if ('token' in message && message.token?.id_token) {
        await fetch(logoutUrl, {
          ...
          body: new URLSearchParams({
            id_token_hint: message.token.id_token as string,
